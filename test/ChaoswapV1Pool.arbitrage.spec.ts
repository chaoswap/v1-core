...
import { ChaoswapV1PoolSwapTest } from '../typechain/ChaoswapV1PoolSwapTest'
...
describe('ChaoswapV1Pool arbitrage tests', () => {
      ...
      for (const passiveLiquidity of [
        ...
        describe(`passive liquidity of ${formatTokenAmount(passiveLiquidity)}`, () => {
          const arbTestFixture = async ([wallet, arbitrageur]: Wallet[]) => {
            ...
            const testerFactory = await ethers.getContractFactory('ChaoswapV1PoolSwapTest')
            const tester = (await testerFactory.deploy()) as ChaoswapV1PoolSwapTest
          ...
          let tester: ChaoswapV1PoolSwapTest
