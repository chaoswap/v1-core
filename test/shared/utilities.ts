...
export function createPoolFunctions({
  ...
  swapTarget: TestChaoswapV1Callee
  token0: TestERC20
  token1: TestERC20
  pool: MockTimeChaoswapV1Pool
}): PoolFunctions {
...
export function createMultiPoolFunctions({
  ...
  swapTarget: TestChaoswapV1Router
  poolInput: MockTimeChaoswapV1Pool
  poolOutput: MockTimeChaoswapV1Pool
}): MultiPoolFunctions {
