...
describe('ChaoswapV1Pool', () => {
  ...
  let pool0: MockTimeChaoswapV1Pool
  let pool1: MockTimeChaoswapV1Pool
  ...
  let swapTargetCallee: TestChaoswapV1Callee
  let swapTargetRouter: TestChaoswapV1Router
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimeChaoswapV1Pool, any]> => {
