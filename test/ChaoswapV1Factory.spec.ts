...
describe('ChaoswapV1Factory', () => {
  ...
  const fixture = async () => {
    ...
    return (await factoryFactory.deploy()) as ChaoswapV1Factory
  }
  ...
  before('load pool bytecode', async () => {
    poolBytecode = (await ethers.getContractFactory('ChaoswapV1Pool')).bytecode
  })
  ...
  async function createAndCheckPool(
    ...
    const poolContractFactory = await ethers.getContractFactory('ChaoswapV1Pool')
